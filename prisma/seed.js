    ...
    data: [
      {
        ...
        alternativaA:
          "Ele abandona os meninos para viver com uma família rica.",
        alternativaB: "Ele se entrega à polícia para cumprir pena.",
        alternativaC:
          "Ele transita de um líder marginalizado para um militante social.",
...

      {
        ...
        alternativaD:
          "A exploração dos trabalhadores nas grandes indústrias paulistas.",
        alternativaE:
          "A corrupção política durante a Era Vargas no Rio de Janeiro.",
        gabarito: "C",
        dificuldade: "FACIL",
        comentarioResolucao:
      ...
      },
      {
        ...
        alternativaE:
          "Ele suborna os guardas noturnos das grandes propriedades.",
        gabarito: "A",
        dificuldade: "MEDIA",
        comentarioResolucao:
      ...
      },
      {
        ...
        alternativaA:
          "Tentar convertê-los ao protestantismo para salvá-los das ruas.",
        alternativaB:
        ...
        alternativaE:
          "Ser o mandante oculto dos furtos realizados pelas crianças.",
        gabarito: "C",
        dificuldade: "MEDIA",
        comentarioResolucao:
      ...
      },
      {
        ...
        alternativaC:
          "Getúlio Vargas; ele entra para a política sindicalista no porto.",
        alternativaD:
      ...
      },
      {
        ...
        alternativaE:
          "É adotado por um juiz e passa a reprimir os antigos companheiros.",
        gabarito: "B",
        dificuldade: "DIFICIL",
        comentarioResolucao:
